...
export default function Home() {
    ...
    <main className="site-main">
      ...
      <section className="hero forge-hero forge-field-hero" id="top">
        ...
        <div className="container forge-field-content reveal-up">
          ...
          <h1><span className="reveal-line"><span className="reveal-line-text hero-heading-line">Technology that moves</span></span><span className="reveal-line"><span className="reveal-line-text"><em>the work forward.</em></span></span></h1>
          ...
          <div className="hero-actions"><a className="button button-primary" href="/contact">Start a project <Icon name="arrow" /></a><a className="text-link" href="/services">Explore our services <Icon name="arrow" /></a></div>
        </div>
      </section>
      ...
      <section className="capability-ticker" aria-label="Forge capabilities" data-motion-reveal="flow"><div className="ticker-track">{[0, 1, 2, 3, 4, 5].map((group) => <div className="ticker-group" aria-hidden={group > 0} key={group}><i>✦</i><span>PRODUCT STRATEGY</span><i>✦</i><span>SOFTWARE DEVELOPMENT</span><i>✦</i><span>AI AUTOMATIONS</span></div>)}</div></section>
  ...
  <span>{number}</span>
      ...
      <footer className="site-footer" data-motion-reveal="flow"><div className="container footer-top" data-motion-item><a className="brand footer-brand" href="#top"><span className="brand-mark"><Image unoptimized src="/forge-mark.png" alt="" width={42} height={42} /></span><span className="brand-name"><strong>Forge</strong><span>Intelligence AI</span></span></a><p>Development, strategy, and AI automation<br />for ambitious businesses.</p><div className="footer-links"><div><span>Explore</span><a href="#about">About</a><a href="/services">Services</a><a href="/projects">Projects</a><a href="#outcomes">What we build</a></div><div><span>Connect</span><a href="mailto:domingo@oneenterprise.ai">Email us</a><a href="/contact">Start your project</a><a href="#faq">FAQ</a></div></div></div><div className="container footer-bottom" data-motion-item><span>© 2026 Forge Intelligence AI</span><span>Built with intent <span className="footer-dot">●</span></span><span><a href="#top">Privacy</a><a href="#top">Terms</a></span></div></footer>
    </main>
  );
}
