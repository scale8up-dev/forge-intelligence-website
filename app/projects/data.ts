...
export const projects: Project[] = [
  ...
  { name: "Praxis Media", category: "AI Projects", description: "An interactive reading experience with instant answers, deeper insights, and personalized AI guidance.", image: "/projects/praxis-media.jpg", url: "https://praxisaimedia.com/", tags: ["React", "AI", "NLP"], featured: true },
  ...
  { name: "PrimeAgeFit", category: "AI Projects", description: "Hyper-personalized fitness and wellness plans that adapt to each member's progress.", image: "/projects/primeagefit.jpg", url: "https://primeagefit.com/", tags: ["React", "Node.js", "AI"], featured: true },
  ...
  { name: "Astrology AI", category: "AI Projects", description: "A personalized astrology experience delivered through an elegant, guided AI interface.", image: "/projects/astrology-ai.jpg", url: "https://astrology-ai.businessevolutionai.com/", tags: ["React", "AI", "Personalization"] },
  ...
  { name: "Life App", category: "AI Projects", description: "Personalized guidance, progress tracking, and education for joint and skin health journeys.", image: "/projects/life-app.png", url: "https://app.beautyandhealthfromwithin.com/", tags: ["React", "AI", "Health"] },
