...
export const projects: Project[] = [
  ...
  { name: "Envision HR 360", category: "Web Solutions", description: "Self-service HR resources, AI-powered assistance, and on-demand access to human expertise for growing businesses.", image: "/projects/envision-hr-360.png", url: "https://www.envisionsola.com/", tags: ["Vue.js", "PostgreSQL", "AI"] },
  ...
  { name: "Vennture", category: "AI Projects", description: "AI-powered growth planning for meaningful relationships, purposeful strategy, and stronger business intelligence.", image: "/projects/vennture.png", url: "https://dev-membership.vennture.com/", tags: ["React", "AI", "Data analytics"] },
