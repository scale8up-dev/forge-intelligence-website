    ...
    <main className="site-main services-page">
      ...
      <footer className="site-footer">
        <div className="container footer-top">
          ...
          <div className="footer-links"><div><span>Explore</span><a href="/#about">About</a><a href="#development">Development</a><a href="#strategy">Strategy</a></div><div><span>Connect</span><a href="mailto:hello@forgeintelligence.ai">Email us</a><a href="/#contact">Start a project</a><a href="/#faq">FAQ</a></div></div>
        </div>
